...
<div id="transp">
  <table WIDTH="600" border="0" cellspacing="3" cellpadding="3">
    <tr>
      ...
      <p>Open the <a href="../../../tools/search/sql.asp" target="tools">SQL Search</a> tool. 
      ...
      all the results to appear - it should take between one and three minutes for the query to run.</p>
          ...
          <table border="1" cellpadding="1" cellspacing="1" width="100%" id="AutoNumber2" bgcolor="#552255">
            <tr>
              ...
              <p>from<br>
              galaxy g, dbo.fGetNearbyObjEq(258.1292,64.0925,5) n</p>
              <p>where<br>
              g.objid = n.objid</p>
              <p></p>
              </td>
      ...
      <a href="../../../help/howto/graph/open.asp" target="tools">Graphing and Analyzing Data</a> 
      ...
      look up each galaxy in the <a href="../../../tools/explore/obj.asp" target="tools">Object 
