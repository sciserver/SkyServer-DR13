...
//	cmd += "<dd>  ph.psfmag_r, ph.psfmag_i, ph.psfmag_z\r\n";
	...
	cmd += "&nbsp;&nbsp;&nbsp;a.teff, a.teff_err, a.logg, a.logg_err, a.m_h, a.m_h_err,<br>\r\n";
	cmd += "&nbsp;&nbsp;&nbsp;a.alpha_m, a.alpha_m_err,<br>\r\n";
	cmd += "&nbsp;&nbsp;&nbsp;<a href=\""+url+"/help/browser/browser.aspx?cmd=description+fApogeeAspcapFlagN+F\">dbo.fApogeeAspcapFlagN</a>(a.aspcapflag),<br>\r\n";
	...
	cmd += "WHERE (a.aspcapflag & <a href=\""+url+"/help/browser/browser.aspx?cmd=description+fApogeeAspcapFlag+F\">dbo.fApogeeAspcapFlag</a>('STAR_BAD')) = 0 and<br>\r\n";
	...
	cmd += "&nbsp;&nbsp;&nbsp;s.apogee_id,s.ra, s.dec, s.glon, s.glat,<br>\r\n";
	cmd += "&nbsp;&nbsp;&nbsp;s.vhelio_avg,s.vscatter,<br>\r\n";
	cmd += "&nbsp;&nbsp;&nbsp;a.teff,a.logg, a.m_h, a.alpha_m,<br>\r\n";
	cmd += "&nbsp;&nbsp;&nbsp;<a href=\""+url+"/help/browser/browser.aspx?cmd=description+fApogeeAspcapFlagN+F\">dbo.fApogeeAspcapFlagN</a>(a.aspcapflag),<br>\r\n";
	cmd += "&nbsp;&nbsp;&nbsp;<a href=\""+url+"/help/browser/browser.aspx?cmd=description+fApogeeStarFlagN+F\">dbo.fApogeeStarFlagN</a>(s.starflag)<br>\r\n";
	cmd += "FROM apogeeStar s<br>\r\n";
	cmd += "&nbsp;&nbsp;&nbsp;JOIN <a href=\""+url+"/help/browser/browser.aspx?cmd=description+aspcapStar+U\">aspcapStar</a> a on a.apstar_id = s.apstar_id<br>\r\n";
	cmd += "WHERE (a.aspcapflag & <a href=\""+url+"/help/browser/browser.aspx?cmd=description+fApogeeAspcapFlag+F\">dbo.fApogeeAspcapFlag</a>('STAR_BAD')) = 0 <br>\r\n";
	cmd += "&nbsp;&nbsp;&nbsp;and a.teff > 0 and a.m_h < -2<br>\r\n";
	cmd += "<br></td></tr>\r\n";
	cmd += "</table>\r\n<br><br>";
	showQuery( qName, qry, cmd, cmd );
	...
	cmd += "&nbsp;&nbsp;&nbsp;aspcap.teff, aspcap.logg, aspcap.m_h<br>\r\n";
	...
	cmd += "WHERE (aspcap.aspcapflag & dbo.fApogeeAspcapFlag('STAR_BAD')) = 0 and aspcap.teff > 0<br>\r\n";
	...
	cmd += "<br>\r\n";
	cmd += "SELECT  top 100<br>\r\n";
	cmd += "  visit.*, aspcap.teff, aspcap.logg, aspcap.m_h<br>\r\n";
	...
	cmd += "WHERE (aspcap.aspcapflag & <a href=\""+url+"/help/browser/browser.aspx?cmd=description+fApogeeAspcapFlag+F\">dbo.fApogeeAspcapFlag</a>('STAR_BAD')) = 0 and aspcap.teff > 0<br>\r\n";
	...
	cmd += "&nbsp;&nbsp;&nbsp;  star.apstar_id, star.ra as star_ra, star.dec as star_dec, <br>\r\n";
	cmd += "&nbsp;&nbsp;&nbsp;  aspcap.teff, aspcap.m_h, aspcap.logg<br>\r\n";
	cmd += "FROM <a href=\""+url+"/help/browser/browser.aspx?cmd=description+apogeeStar+U\">apogeeStar</a> AS star <br>\r\n";
