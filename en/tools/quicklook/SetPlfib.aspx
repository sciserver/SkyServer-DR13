<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetPlfib.aspx.cs" Inherits="SkyServer.Tools.QuickLook.SetPlfib" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function press_ok() {
            ...
            var w = window.open('quickobj.aspx?plate=' + f.plate.value + '&mjd=' + f.mjd.value + '&fiber=' + f.fiber.value, 'EXPLORE');
            window.close();
            w.focus();
            return;
        }
