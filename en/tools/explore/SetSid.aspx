<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetSid.aspx.cs" Inherits="SkyServer.Tools.Explore.SetSid" %>
...
<body bgcolor="#000000" text="white" topmargin="0" leftmargin="10" onload="init()">
    ...
    <div>
        ...
        <table cellspacing="12"><tr><td class="wtxt">
	        Enter the SpecObjId,<br> then press OK
	        </td></tr>
        </table>

        <form action="" method=post id="F1">
	        <table BORDER=2 width=200 bgcolor=#000040>
		        <tr><td class="wtxt">SpecObjId</td>
