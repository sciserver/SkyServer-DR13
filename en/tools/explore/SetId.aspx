<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetId.aspx.cs" Inherits="SkyServer.Tools.Explore.SetId" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function press_ok() {
            ...
            var w = window.open("obj.aspx?id=" + f.objid.value, 'EXPLORE');
            window.close();
            w.focus();
            return;
        }
